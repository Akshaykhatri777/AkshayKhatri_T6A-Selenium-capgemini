...
wait.until(EC.visibility_of_element_located((By.XPATH, "//input[@class='nw1UBF v1zwn25']"))).send_keys('shirts')
wait.until(EC.visibility_of_element_located((By.XPATH, "//button[@class='XFwMiH']"))).click()
print(wait.until(EC.visibility_of_element_located((By.XPATH, "(//div[@data-id])[6]//a[@class='atJtCj Qum9aC']"))).text)
